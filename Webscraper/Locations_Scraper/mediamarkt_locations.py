...
class MediaMarktLocationsScraper(Scraper):
    ...
    def scrape_location_details(self):
        ...
        for locationSource in self.dataSources:
            ...
            root_urls = soup.find('section', class_='StyledSection-hamlz2-0 iFgEJv')
            children_urls = root_urls.findChildren('a')
            for child in children_urls:
                self.urls.append("https://www.mediamarkt.de"+str(child['href']))
            counter = 0
            ...
            for child in self.urls:
                ...
                locations = soup.find_all(class_="BaseTypo-sc-1jga2g7-0 izkVco StyledInfoTypo-sc-1jga2g7-1 boCWcc")
