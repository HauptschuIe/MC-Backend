import re
from HelperClasses.fact_newsletterWords import Fact_NewsletterWords
from Middleware.dbOperations_Read import getWordsForNewsletterWords
from collections import Counter
from datetime import datetime

class NewsletterWordcount():
    def wordcount_newsletter(self):
        facts = []
        innerFacts = []
        ...
        for competitor in competitors: 
            ...
            for word in counts:
                fact_newsletterWords = Fact_NewsletterWords()
                fact_newsletterWords.competitor_id = competitor
                fact_newsletterWords.timestamp = datetime.now()
                fact_newsletterWords.word = word[0]
                fact_newsletterWords.quantity = word[1]

                rank += 1
                fact_newsletterWords.rank = rank

                facts.append(fact_newsletterWords)
