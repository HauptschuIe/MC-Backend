...
class SaturnProductScraper(Scraper):
    ...
    def scrape_product_details(self):
        ...
        for productSource in self.dataSources:
            ...
            check_price_status = soup.find(class_="StyledBrandedStrikePrice-sc-1stgwju-2 hdlayb")
            if check_price_status is not None:
                ...
                fact_product_informations.price = soup.find_all(class_='ScreenreaderTextSpan-sc-11hj9ix-0 kZCfsu')[0].text
